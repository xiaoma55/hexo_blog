...
function  create() {
    ...
    kd.href = 'https://xiaoma.cool/customerPage/youqu/zhaoYaoJing/tool/ph/?id='+myid.value+'&url='+url.value; //修改此处的域名 必须要SSL证书 www.luyuz.cn 路羽资源博客
    kd.style = ''; 
    kd.innerText = 'https://xiaoma.cool/customerPage/youqu/zhaoYaoJing/tool/ph/?id='+myid.value+'&url='+url.value; //修改此处的域名  必须要SSL证书  www.luyuz.cn 路羽资源博客
}
</script>
<div id="bob">
...
<div class="mianban">
    ...
    <a href="http://ex666.cn/" id="M1" style="background-color: rgb(0, 153, 204);">点击网址缩短</a>
    <a href="https://jq.qq.com/?_wv=1027&k=Ku0NT6UT" id="M1" style="background-color: rgb(0, 153, 204);">点击加入群聊</a>
...
请收藏本站,以防丢失 </textarea>
			...
			<div class="ft">网恋照妖镜</div>
               ...
               <div width="100px" height="100px" style=" margin: 10px auto; border: 1px solid #ccc; text-align: center">
               	...
               	<a href="https://www.luyuz.cn/" id="M1" style="background-color: #af00ff;">路羽资源博客</a> <a href="https://www.ovdh.cn/apply.html" id="M1" style="background-color: #2ed000;">欧维免费收录</a> <a href="https://www.luyuz.cn/tools.html" id="M1" style="background-color: #09c5de;">在线工具</a> <a href="https://www.luyuz.cn/tools/ali" id="M1" style="background-color: #ff7a7a;">阿里图床</a> <a href="https://www.luyuz.cn/tools/shenmiao" id="M1" style="background-color: #d4a40a;">在线逃亡游戏</a>                </div>
